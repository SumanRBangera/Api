...
using Web_Angular_Api.Models;

namespace Web_Angular_Api.Controllers
{
    public class RegistrationsController : Controller
    {
        private readonly Angular_ApiContext _context;

        public RegistrationsController(Angular_ApiContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'Angular_ApiContext.Registrations'  is null.");
            }
            var registration = await _context.Registrations.FindAsync(id);
            if (registration != null)
            {
